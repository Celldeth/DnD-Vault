level 3 - #transmutation Casting Time: #BonusAction, which you can take immediately after hitting or missing a target with a ranged attack using a weapon Range: Self Components: V, S Duration: Instantaneous 
