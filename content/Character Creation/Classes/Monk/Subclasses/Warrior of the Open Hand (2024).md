...
- _**Addle.**_ The target can’t make Opportunity Attacks until the start of its next turn.
    
- _**Push.**_ The target must succeed on a Strength saving throw or be pushed up to 15 feet away from you.
    
- _**Topple.**_ The target must succeed on a Dexterity saving throw or have the Prone condition.
