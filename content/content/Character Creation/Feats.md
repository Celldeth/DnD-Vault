...
# Mal'Gama Feats
[*] = Homebrewed or modified from original feat

[N/A]= Not available as a selection currently
...
Through your repeated exposure to the natural flow of arcane magic through Mal’Gama you’ve adapted to attune with additional enchantments. You gain the following benefits:
...
-   Being flanked no longer gives enemies an advantage against you.
...
-   If you attempt to cast a spell that requires concentration while already concentrating on an existing spell, you can maintain concentration on both spells simultaneously. While concentrating on two spells, the only spells that you may cast are cantrips.
    
-   At the end of each turn where you have two spells you are concentrating on, you must make a Constitution saving throw (DC equals 10 + both spells’ levels combined). On a success, you maintain concentration on both spells. On a failure, you lose concentration on both spells. 
    

-   To avoid this saving throw - you can either use an action to maintain concentration or you can drop concentration on one of your spells during your turn as a free action.
...
Alert to the hidden [[30 DM resources/Traps/Traps]] and secret doors found in many dungeons, you gain the following benefits:

-   When you roll a Hit Die to regain hit points, the minimum number of hit points you regain from the roll equals twice your Constitution modifier (minimum of 2).
    
-   You have advantage on Wisdom (Perception) and Intelligence (Investigation) checks made to detect the presence of secret doors.
    
-    You have advantage on saving throws made to avoid or resist [[30 DM resources/Traps/Traps]].
    
-    You have resistance to the damage dealt by [[30 DM resources/Traps/Traps]].
    
-    You can search for [[30 DM resources/Traps/Traps]] while traveling at a normal pace, instead of only at a slow pace.
...
-   When you roll a Hit Die to regain hit points, the amount of hit points regained is equal to the die roll plus twice your Constitution modifier (minimum of 2)
...
Studying occult lore, you have unlocked eldritch power within yourself: you learn one [[content/Character Creation/Classes/Warlock/Warlock#Eldritch Invocations\|Eldritch Invocation]] option of your choice from the warlock class.
...
Spending countless hours winning and listing coins in ale-stained taverns has forged you into a consummate gambler and chance-seeking addict. You gain the following benefits and features:
...
## Great Weapon Handler*

Prerequisite: Strength 13 or higher

-   You now treat the two-handed property for melee weapons as Versatile. When wielding a two-handed weapon in one hand, reduce the damage dice by one category. Ex: wielding a greatsword in one hand would deal 2d4 damage instead of 2d6.
    
-   Gain Cleave: When a melee attack with a heavy weapon reduces an undamaged creature to 0 hit points, any excess damage from that attack might carry over to another creature nearby. The attacker targets another creature within reach and, if the original attack roll can hit it, applies any remaining damage to it. If the creature is likewise reduced to 0 hit points, repeat this process, carrying over the remaining damage until there are no valid targets, or until the damage carried over fails to reduce an undamaged creature to 0 hit points.
...
-   Before you make a melee attack with a heavy weapon that you are proficient with, you can choose to make an attack roll without your proficiency bonus. If the attack hits, double your proficiency bonus and add it to the attack’s damage.
...
Putting your body through extreme conditions and pain, your body has begun to adapt extremely well to healing itself through extraordinary means, gifting you the following benefits:
...
-   While you are wearing heavy armor, bludgeoning, piercing, and slashing damage that you take from non magical weapons is reduced by the amount of your proficiency bonus.
...
You’re a shrewd businessman and you’ve haggled, negotiated, and talked down every price you’ve ever been given. You know what to say and exactly how to say it to give yourself the better deal.

-   When buying and selling from humanoid merchants, before you roll you can forgo your charisma check for a better deal and instead take a flat 15% discount/mark-up on all items you are buying/selling. Does not stack with other discounts that may have been given.
...
-   When you take the Attack action and attack with a glaive, halberd, spear, or quarterstaff, you can use a bonus action to make a melee attack with the opposite end of the weapon. The weapon’s damage die for this attack is a d4, and the attack deals bludgeoning damage. 
...
-   Before you make an attack with a ranged weapon that you are proficient with, you can choose to make an attack roll without your proficiency bonus. If the attack hits, double your proficiency bonus and add it to the attack’s damage.
...
-   utterances are in a language you know, and the creature understands you only if it knows that language. Your communication doesn't give the creature the ability to respond to you telepathically.
...
-   You gain proficiency with cook’s utensils. If you are already proficient with this tool, you gain expertise, which means your proficiency bonus is doubled for any ability check you make with it. This proficiency doesn’t benefit from multiple sources of expertise. 
    
-   Extends food effects to last until 24 hrs. As usual effects do not stack.
...
-   You gain proficiency with the poisoner’s kit. If you are already proficient with this tool, you gain expertise, which means your proficiency bonus is doubled for any ability check you make with it. This proficiency doesn’t benefit from multiple sources of expertise.
